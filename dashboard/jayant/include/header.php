...
<html lang="en">
  <head>
    ...
    <title>Jayant's DashBoard</title>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon ion-ios-folder-outline tx-20"></i>
            <span class="menu-item-label">Skill Category</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div>
        </a>
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="skill-category.php" class="nav-link">All Categories</a></li>
          <li class="nav-item"><a href="skill-category-new.php" class="nav-link">New Category</a></li>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="project-category.php" class="nav-link">All Categories</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="detail.php" class="nav-link">All Details</a></li>
          <li class="nav-item"><a href="detail-new.php" class="nav-link">New Detail</a></li>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="contacts.php" class="nav-link">All Contacts</a></li>
        </ul>
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name">Jayant<span class="hidden-md-down"> Sharma</span></span>
            ...
            <a href="" class="media-list-link">
              <div class="media">
                ...
                <div class="media-body">
                  <p class="mg-b-0 tx-medium tx-gray-800 tx-13">Jayant Sharma</p>
          ...
          <div class="media-list">
            <a href="" class="media-list-link read">
              <div class="media pd-x-20 pd-y-15">
                <img src="" class="wd-40 rounded-circle" alt="">
                <div class="media-body">
                  <p class="tx-13 mg-b-0 tx-gray-700"><strong class="tx-medium tx-gray-800">Jayant Sharma</strong> now visti your dashboard.</p>
                  <span class="tx-12">july 27, 2020 6:45am</span>
                </div>
              </div><!-- media -->
            </a>
