...
<html lang="en">
  <head>
    ...
    <!-- Meta -->
    <meta name="description" content="Jayant Dashboard">
    <meta name="author" content="Jayant">

    <title>Jayant Sign-Up System</title>
    ...
    <div class="d-flex align-items-center justify-content-center bg-sl-primary">
      ...
      <form action="signup.php" method="POST" enctype="multipart/form-data">
        <div class="login-wrapper wd-300 wd-xs-400 pd-25 pd-xs-40 bg-white">
          <div class="signin-logo tx-center tx-24 tx-bold tx-inverse">Jayant <span class="tx-info tx-normal">Sharma</span></div>
          ...
          <div class="form-group tx-12">Jayant Has Only Permission For Signup</div>
