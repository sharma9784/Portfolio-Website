...
<div class="sl-mainpanel">
  <nav class="breadcrumb sl-breadcrumb">
    ...
    <span class="breadcrumb-item active">Skill Category</span>
  </nav>
  ...
  <div class="sl-pagebody">
    ...
    <div class="row row-sm bg-light rounded">
		<div class="col-md-12 text-dark">
			<div align="center">
				<h4 class="text-center pt-2">New Skill Category</h4>
				<hr>
...
<?php 
	if (isset($_POST['submit'])) {
		...
		$sql = "INSERT INTO skills_category (name,status) VALUES ('$name','$status')";
